...
import '../scss/utils/_swiper.scss';
...
export const Recommendations = () => {
  return (
    <>
      ...
      <p className="section-rec__desc">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. lorem ipsum</p>
       <Swiper
        slidesPerView={1}
        spaceBetween={10}
        pagination={{
      ...
      >
        ...
        <SwiperSlide>
         <div className="section-rec__item">
          ...
          <p className="section-rec__item-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vitae nulla diam in ac dictum a urna viverra morbi. Morbi donec amet....</p>
