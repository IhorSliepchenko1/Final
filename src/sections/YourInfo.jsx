    ...
    <section className="contacts container">
        ...
        <div className="contacts__form">
            ...
            <form className="forms">
                ...
                <input className="forms__input" type="text" name="name" placeholder="" />
                <span className="forms__name">Your Email ( Required)</span>
                <input className="forms__input" type="text" name="mail" placeholder="" />
                <span className="forms__name">Subject</span>
                <input className="forms__input" type="text" name="name" placeholder="" />
                <span className="forms__name">Your Message</span>
                <textarea className="forms__textarea" type="text" name="Bio" placeholder=""></textarea>
